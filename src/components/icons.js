...
export function Linkedin(){
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-linkedin custom-image-color" viewBox="0 0 16 16">
...
export function Moon(){
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-moon me-1" viewBox="0 0 16 16">
...
export function Download(){
    return(
        <img src={download_icon} alt="" style={{marginRight:'0.3rem'}}/>
    )
}